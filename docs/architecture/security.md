...
The build scans the embedded recovery configuration and rejects nonempty password, PSK, token, secret, or private-key fields. Device identity and administrator credentials remain per-device provisioning data.
