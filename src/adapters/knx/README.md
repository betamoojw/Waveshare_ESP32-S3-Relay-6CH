...
The normative implemented product interface is [KNX/IP](../../../docs/protocols/knx-ip.md).
The broader commercial feature requirements remain a roadmap and do not imply
that hidden objects are available in this firmware.
...
- A zero group address disables that binding in the current schema. This compatibility representation cannot assign the valid KNX address `0/0/0`; the ETS association model must represent "unassigned" separately.
